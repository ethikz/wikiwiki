$(document).ready(function(){
  $('.article-select').each(function(){
    ...
    $(this).click(function(){
      if($(this).hasClass('active-article-select')) {
        // roll up roll up
        $(this).children('.selectdropdown').slideUp(200);
        $(this).removeClass('active-article-select');
        ...
        $('.active-article-select').each(function(){
          $(this).children('.selectdropdown').slideUp(200);
          // change span back to selected option text
          if($(this).children('select').val() != '0') {
            $(this).children('.desc').fadeOut(100, function(){
        ...
        $(this).addClass('active-article-select');
  ...
  $('.article-select .selectdropdown span').click(function(){
